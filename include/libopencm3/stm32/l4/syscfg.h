...
#define SYSCFG_CFGR1_MEM_MODE_MASK	7
...
#define SYSCFG_CFGR1_MEM_MODE_QSPI	6

/* --- SYSCFG_CFGR1 Values ------------------------------------------------- */

#define SYSCFG_CFGR2_FPU_IE5		(1 << 31)
#define SYSCFG_CFGR2_FPU_IE4		(1 << 30)
#define SYSCFG_CFGR2_FPU_IE3		(1 << 29)
#define SYSCFG_CFGR2_FPU_IE2		(1 << 28)
#define SYSCFG_CFGR2_FPU_IE1		(1 << 27)
#define SYSCFG_CFGR2_FPU_IE0		(1 << 26)

#define SYSCFG_CFGR2_I2C3_FMP		(1 << 22)
#define SYSCFG_CFGR2_I2C2_FMP		(1 << 21)
#define SYSCFG_CFGR2_I2C1_FMP		(1 << 20)

#define SYSCFG_CFGR2_I2C_PB9_FMP	(1 << 19)
#define SYSCFG_CFGR2_I2C_PB8_FMP	(1 << 18)
#define SYSCFG_CFGR2_I2C_PB7_FMP	(1 << 17)
#define SYSCFG_CFGR2_I2C_PB6_FMP	(1 << 16)

#define SYSCFG_CFGR2_BOOSTEN		(1 << 8)
